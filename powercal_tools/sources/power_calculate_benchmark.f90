...
implicit none
  ...
  call power_read_timephases_from_file('/nas_home//hpcfapix/hpcfapix/measure/data/seq.dat', num_phases, start_time, end_time)
  ...
  do ii=1_ik,num_components
    ...
    current_first_measurement_sec = current_timesteps_sec%sec(1_ik) - current_measure_interval_sec
    volt_first_measurement_sec = volt_timesteps_sec%sec(1_ik) - volt_measure_interval_sec
  ...
  call power_read_performance_from_file("/nas_home//hpcfapix/hpcfapix/measure/data/seq.dat", num_lines, length, performance)
  call power_energy_write_to_file("/nas_home//hpcfapix/hpcfapix/measure/data/seq_energy.dat", length, performance, energy)
